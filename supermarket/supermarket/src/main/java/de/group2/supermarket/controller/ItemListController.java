...
public class ItemListController {
    ...
    public ResponseEntity<Object> add(@RequestBody ItemList itemList) {
        ...
        return new ResponseEntity<Object>(itemListRepository.save(itemList), HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<Object> getById(@PathVariable UUID id) {
        ...
        try {
            ...
            return new ResponseEntity<Object>("ItemList with the id " + id + " could not be found", HttpStatus.NOT_FOUND);
        }
    }
